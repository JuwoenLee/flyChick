...
void Init_Infinite()
{
	...
	if (chick_dress == 1)
	{
		SDL_Surface* chick_sheet_surface = IMG_Load("../Resources/egg_ari_sheet.png");
		chick_sheet_texture = SDL_CreateTextureFromSurface(g_renderer, chick_sheet_surface);
		SDL_FreeSurface(chick_sheet_surface);

		// chick sheet  x, y, w, h
		chick_rect[0] = { 88, 90, 300, 300 };
		chick_rect[1] = { 570, 89, 300, 301 };
		chick_rect[2] = { 1050, 89, 300, 301 };

		chick_destination_rect.x = (int)chick_x;
		chick_destination_rect.y = (int)chick_y;
		chick_destination_rect.w = chick_rect[0].w / 4.5;
		chick_destination_rect.h = chick_rect[0].h / 4.5;
	}
	
	if (chick_dress == 2)
	{
		SDL_Surface* chick_sheet_surface = IMG_Load("../Resources/angel_ari_sheet.png");
		chick_sheet_texture = SDL_CreateTextureFromSurface(g_renderer, chick_sheet_surface);
		SDL_FreeSurface(chick_sheet_surface);

		// chick sheet  x, y, w, h
		chick_rect[0] = { 88, 28, 301, 352 };
		chick_rect[1] = { 570, 37, 300, 352 };
		chick_rect[2] = { 1050, 37, 300, 352};
	...
	if (chick_dress == 3)
	{
		SDL_Surface* chick_sheet_surface = IMG_Load("../Resources/devil_ari_sheet.png");
		chick_sheet_texture = SDL_CreateTextureFromSurface(g_renderer, chick_sheet_surface);
		SDL_FreeSurface(chick_sheet_surface);

		// chick sheet  x, y, w, h
		chick_rect[0] = { 89, 72, 300, 319 };
		chick_rect[1] = { 570, 71, 300, 319 };
		chick_rect[2] = { 1050, 71, 300, 319 };
	...
	if (chick_dress == 4)
	{
		SDL_Surface* chick_sheet_surface = IMG_Load("../Resources/sailormoon_ari_sheet.png");
		chick_sheet_texture = SDL_CreateTextureFromSurface(g_renderer, chick_sheet_surface);
		SDL_FreeSurface(chick_sheet_surface);

		// chick sheet  x, y, w, h
		chick_rect[0] = { 89, 98, 302, 282 };
		chick_rect[1] = { 570, 108, 300 ,282 };
		chick_rect[2] = { 1050, 99, 300, 282 };
